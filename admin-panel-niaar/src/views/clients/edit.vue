  ...
  methods: {
    getData() {
      axios.get(`/admin/users/${this.$route.params.id}`).then((response) => {
        ...
        this.confidential = response.data.data.confidential;
        ...
        this.company_number = response.data.data.company_number;
        this.contact_name_2 = response.data.data.contact_name_2;
        this.mobile_number_2 = response.data.data.mobile_number_2;
        this.company_abbreviation = response.data.data.company_abbreviation;
      });
    },
              ...
              this.$router.replace("/clients").then(() => {
                this.$toast({
                  ...
                  props: {
                    ...
                    icon: "CoffeeIcon",
                    variant: "success",
                    text: `You have successfully edited ${this.firstName} ${this.lastName} as a ${this.role}!`,
                  },
                });
              });
            })

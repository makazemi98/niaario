  ...
  <section>
    ...
    >
      <div>
        ...
        <span class="ml-1 fs-sm">Search In Clients ...</span>
      </div>
        ...
        <div>
          <b-card no-body>
            ...
            >
              ...
              <b-button
                v-if="userData.role !== 'accountant'"
                variant="gradient-success"
                size="sm"
                to="/clients/create"
              >
                <feather-icon icon="PlusIcon" class="mr-50" />
                <span class="align-middle"> New Client </span>
              </b-button>
            </div>
            <div v-if="isLoaded">
              <b-table
              ...
              >
                ...
                <template #cell(action)="data">
                  ...
                  >
                    <b-dropdown-item :to="`/clients/${data.item.id}`">
                      <small>Edit</small>
                    </b-dropdown-item>

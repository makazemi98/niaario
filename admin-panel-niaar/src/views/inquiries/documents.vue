  ...
  <div>
    <b-card v-if="!loading">
      ...
      <b-button
        ...
        size="sm"
      >
        <feather-icon v-if="!whileUploading" icon="UploadCloudIcon" />
        <span class="align-middle" v-if="!whileUploading"> Upload </span>
        <span class="align-middle" v-else> Loading... </span>
      </b-button>
        ...
        >
          ...
          <template #cell(action)="data">
            <b-button
              ...
              @click="deleteDoc(data.item.id, data.item.file_name)"
            >
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      axios
        .get(`/admin/inquiries/${this.$route.params.id}/docs/docs`, {})
        .then((response) => {

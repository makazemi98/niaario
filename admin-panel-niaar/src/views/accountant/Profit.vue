          ...
          <b-card v-if="list" no-body>
            ...
            >
              ...
              <template #cell(meta)="data">
                Assumed Profit:
                <b>{{ data.item.meta.profit.assumed_profit }}</b>
                <hr />
                Actual Profit: <b>{{ data.item.meta.profit.assumed_profit }}</b>
              </template>
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "meta", label: "Profit", sortable: true },
        { key: "status", label: "Status", sortable: true },
        { key: "title", label: "Title", sortable: true },
        { key: "update_at", label: "Updated at", sortable: true },

...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'Register V1', route: { name: 'auth-register-v1' }, icon: 'PlusIcon', isBookmarked: false },
      { title: 'Register V2', route: { name: 'auth-register-v2' }, icon: 'PlusIcon', isBookmarked: false },
